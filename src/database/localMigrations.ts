/**
 * Local database migration system for schema updates
 */

import { getLocalDatabaseConnection } from "./localConnection.js";
import { logger } from "../utils/logger.js";
import { Migration } from "./types.js";

export class LocalMigrationManager {
  private readonly dbLogger = logger.child({
    component: "LocalMigrationManager",
  });
  ...
  async initializeMigrationsTable(): Promise<void> {
    try {
      const db = getLocalDatabaseConnection();
